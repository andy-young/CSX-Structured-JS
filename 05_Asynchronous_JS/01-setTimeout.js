...
// Beneath that console log, set a timer (see setTimeout) that will log to the
// console 'I am in the setTimeout callback function' after 600 ms.

// Next, add code to the end of the challenge to log 'I am at the end of the code'.
// Now re - run the code.

// Make sure the 'console' and 'output' panes are showing (click the tabs above if not)
// and then run your code with the 'run' button.
